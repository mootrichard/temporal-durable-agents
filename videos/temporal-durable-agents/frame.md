...
description: >
  ...
  display + Inter body + Noto Sans Mono for the index/code voice on a warm-navy code surface,
...
typography:
  ...
  kicker:  { fontFamily: "Noto Sans Mono", px: 28, cqw: 1.46, weight: 500, tracking: "0.16em", upper: true }
  mono-label:{ fontFamily: "Noto Sans Mono", px: 26, cqw: 1.35, weight: 500, tracking: "0.02em" }
  code:    { fontFamily: "Noto Sans Mono", cqw: 1.67, weight: 400, lineHeight: 1.6 }
  ...
  number-unit:{ fontFamily: "Noto Sans Mono", cqw: 2.08, weight: 500, lineHeight: 1.0 }
...
components:
  ...
  kicker-spike:
    ...
    description: "The eyebrow — Noto Sans Mono uppercase, indexical (2–5 words), prefixed with the coral ✱. Never plain text, never a sentence."
  coral-callout:
  ...
  number-lockup:
    ...
    description: "Hero stat — a Inter figure paired with a Noto Sans Mono unit (200K, +1,204, −318, 17 files). Figure is serif; the unit is ALWAYS mono, never the serif."
  pull-quote:
  ...
  code-surface:
    ...
    textColor: "{colors.cream} (Noto Sans Mono); syntax in coral (keywords) / teal #5DB8A6 (strings) / amber #E8A55A (numbers)"
...
- **Fonts** — already set to **Noto Sans Mono** (display) / **Inter** (body); ignore any preset font name lingering in prose.
...
UI chrome. **Noto Sans Mono** carries the indexical layer — kickers, technical labels, the code
...
- **Inter** (sentence case, negative-tracked) for all display; **Inter** body/chrome; **Noto Sans Mono** index + code.
...
- **Type** — Inter sentence-case display (negative-tracked); Inter 400 body; Noto Sans Mono kickers (uppercase 0.16em, coral ✱) + code.
...
- Set all display in **Inter, sentence case**, negative-tracked; **Inter 400** body; **Noto Sans Mono** kickers (uppercase, 0.16em, coral ✱) + code.
...
- **Type** — Inter sentence-case display (negative-tracked); Inter 400 body; Noto Sans Mono kickers (uppercase 0.16em, coral ✱) + code; ≥1.4cqw floor.
...
```html
<style>
@font-face{font-family:"Aeonik Air";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/AeonikAir-Regular.woff") format("woff");}
@font-face{font-family:"Aeonik Air";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/AeonikAir-Regular.woff2") format("woff2");}
@font-face{font-family:"Aeonik Air";font-weight:400;font-style:italic;font-display:block;src:url("assets/fonts/AeonikAir-Regular-Italic.woff") format("woff");}
@font-face{font-family:"Aeonik Air";font-weight:400;font-style:italic;font-display:block;src:url("assets/fonts/AeonikAir-Regular-Italic.woff2") format("woff2");}
@font-face{font-family:"Aeonik";font-weight:500;font-style:italic;font-display:block;src:url("assets/fonts/Aeonik-Medium-Italic.woff") format("woff");}
@font-face{font-family:"Aeonik";font-weight:500;font-style:italic;font-display:block;src:url("assets/fonts/Aeonik-Medium-Italic.woff2") format("woff2");}
@font-face{font-family:"Aeonik";font-weight:400;font-style:italic;font-display:block;src:url("assets/fonts/Aeonik-Regular-Italic.woff") format("woff");}
@font-face{font-family:"Aeonik";font-weight:400;font-style:italic;font-display:block;src:url("assets/fonts/Aeonik-Regular-Italic.woff2") format("woff2");}
@font-face{font-family:"Aeonik";font-weight:300;font-style:italic;font-display:block;src:url("assets/fonts/Aeonik-Light-Italic.woff") format("woff");}
@font-face{font-family:"Aeonik";font-weight:300;font-style:italic;font-display:block;src:url("assets/fonts/Aeonik-Light-Italic.woff2") format("woff2");}
...
@font-face{font-family:"Inter";font-weight:500;font-style:normal;font-display:block;src:url("assets/fonts/Inter-500.woff") format("woff");}
@font-face{font-family:"Noto Sans Mono";font-weight:900;font-style:normal;font-display:block;src:url("assets/fonts/NotoSansMono-900.woff") format("woff");}
@font-face{font-family:"Noto Sans Mono";font-weight:900;font-style:normal;font-display:block;src:url("assets/fonts/NotoSansMono-900.woff2") format("woff2");}
@font-face{font-family:"Noto Sans Mono";font-weight:800;font-style:normal;font-display:block;src:url("assets/fonts/NotoSansMono-800.woff2") format("woff2");}
@font-face{font-family:"Noto Sans Mono";font-weight:800;font-style:normal;font-display:block;src:url("assets/fonts/NotoSansMono-800.woff") format("woff");}
</style>
```
